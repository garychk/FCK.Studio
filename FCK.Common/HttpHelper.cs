...
namespace FCK.Common
{
    public class HttpHelper
    {
        ...
        public static string HttpWebPost(string apiurl, SortedDictionary<string, string> sParaTemp)
        {
            //待请求参数数组字符串
        ...
        public static string BuildRequestParaToString(SortedDictionary<string, string> dicArray, Encoding code)
        {
            StringBuilder prestr = new StringBuilder();
            foreach (KeyValuePair<string, string> temp in dicArray)
            {
                prestr.Append(temp.Key + "=" + System.Web.HttpUtility.UrlEncode(temp.Value, code) + "&");
            }
